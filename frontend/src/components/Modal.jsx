...
export default function Modal({ open, onClose, title, children, maxWidthClass = 'max-w-lg' }) {
  ...
  return (
    ...
    >
      <div className={`w-full ${maxWidthClass} rounded-lg bg-white p-6 shadow-xl`}>
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-md text-slate-400 hover:bg-slate-100 hover:text-slate-600"
          >
