      ...
      <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-bold text-slate-900">Quote {quote.number}</h1>
          </div>
        ...
        <div className="mt-6 grid gap-4 text-sm sm:grid-cols-2">
          ...
          <div>
            ...
            <p className="text-slate-900">{quote.issue_date}</p>
            {quote.expiry_date && (
              <>
                <p className="mt-2 font-medium text-slate-500">Expires</p>
                <p className="text-slate-900">{quote.expiry_date}</p>
              </>
            )}
          </div>
        </div>
        ...
        {notice && <p className="mt-6 text-sm text-emerald-600">{notice}</p>}
          ...
          {canRespond && (
            <>
              ...
              <button
                ...
                disabled={busy}
                className="min-h-11 rounded-md border border-red-300 px-4 text-sm font-medium text-red-600 hover:bg-red-50 disabled:opacity-60"
              >
                Decline
              </button>
            </>
